...
public class Cookie {
    ...
    private static final Logger logger = LogManager.getLogger("Cookie");
    ...
    public void setUp() {
        ...
        public void login() {
            ...
            new WebDriverWait(driver, Duration.ofSeconds(5)).until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//div[2]/form/div[2]/input"))))
